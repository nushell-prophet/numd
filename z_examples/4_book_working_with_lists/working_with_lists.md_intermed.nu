...
[1, 2, 3, 4] | insert 2 10 | table --width 120 | default '' | into string | lines | each {$'# => ($in)' | str trim --right} | str join (char nl) | print; print ''
...
[1, 2, 3, 4] | update 1 10 | table --width 120 | default '' | into string | lines | each {$'# => ($in)' | str trim --right} | str join (char nl) | print; print ''
...
let colors = ($colors | append purple)
let colors = ("black" | append $colors)
$colors | table --width 120 | default '' | into string | lines | each {$'# => ($in)' | str trim --right} | str join (char nl) | print; print ''
...
$names | enumerate | each { |elt| $"($elt.index + 1) - ($elt.item)" } | table --width 120 | default '' | into string | lines | each {$'# => ($in)' | str trim --right} | str join (char nl) | print; print ''
...
let scores = [7 10 8 6 7]
$scores | where $it > 7 | table --width 120 | default '' | into string | lines | each {$'# => ($in)' | str trim --right} | str join (char nl) | print; print ''
...
$scores | enumerate | reduce --fold 0 { |elt, acc| $acc + $elt.index * $elt.item } | table --width 120 | default '' | into string | lines | each {$'# => ($in)' | str trim --right} | str join (char nl) | print; print ''
...
let names = [Mark Tami Amanda Jeremy]
$names.1 | table --width 120 | default '' | into string | lines | each {$'# => ($in)' | str trim --right} | str join (char nl) | print; print ''
...
let names = [Mark Tami Amanda Jeremy]
let index = 1
$names | get $index | table --width 120 | default '' | into string | lines | each {$'# => ($in)' | str trim --right} | str join (char nl) | print; print ''
...
let colors = []
$colors | is-empty | table --width 120 | default '' | into string | lines | each {$'# => ($in)' | str trim --right} | str join (char nl) | print; print ''
...
'blue' in $colors # true
'yellow' in $colors # false
'gold' not-in $colors | table --width 120 | default '' | into string | lines | each {$'# => ($in)' | str trim --right} | str join (char nl) | print; print ''
...
# Are any scores odd?
$scores | any {|elt| $elt mod 2 == 1 } | table --width 120 | default '' | into string | lines | each {$'# => ($in)' | str trim --right} | str join (char nl) | print; print ''
...
# Are all scores even?
$scores | all {|elt| $elt mod 2 == 0 } | table --width 120 | default '' | into string | lines | each {$'# => ($in)' | str trim --right} | str join (char nl) | print; print ''
...
[[1 2] [3 [4 5 [6 7 8]]]] | flatten | flatten | flatten | table --width 120 | default '' | into string | lines | each {$'# => ($in)' | str trim --right} | str join (char nl) | print; print ''
...
# Show world clock for selected time zones
$zones | wrap 'Zone' | upsert Time {|row| (date now | date to-timezone $row.Zone | format date '%Y.%m.%d %H:%M')} | table --width 120 | default '' | into string | lines | each {$'# => ($in)' | str trim --right} | str join (char nl) | print; print ''
