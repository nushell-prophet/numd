...
/Users/user/.cargo/bin/nu -c "[{a:1 b:2} {b:1}]"| complete | if ($in.exit_code != 0) {get stderr} else {get stdout} | print
print ''

print ("> [{a:1 b:2} {b:1}].1.a" | nu-highlight)
/Users/user/.cargo/bin/nu -c "[{a:1 b:2} {b:1}].1.a"| complete | if ($in.exit_code != 0) {get stderr} else {get stdout} | print
print ''
